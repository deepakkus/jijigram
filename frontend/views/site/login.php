						...
						<div class="col-lg-6 zzcol-md-12 col-sm-12 col-xs-12" style="background: #732699; border-radius: 4px 0px 0px 4px;">
							<div class="cmp-info">
								<div class="cm-logo">
									...
									<?php $totalnominated = Yii::$app->db->createCommand( 'SELECT count(total_nominated) as tot,leader_name  FROM  nominated_leader group by leader_name ORDER BY total_nominated DESC limit 9 ')->queryAll();
									?>
									<?php foreach($totalnominated as $row) {?>
									<?php //print_r($row); ?>
									<div class=" cucnt_ldr text-center">
									<div class="  pdng_tp_40px"><span class="pt_fil"><b><?php echo $row['leader_name']; ?> </b></span></div>
									<div class="   pdng_tp_40px"><?php echo $row['tot'];?></div>
									</div>
									<?php } ?>
...
<input type="text" id="nominateleader-leader_name" class="form-control" name="NominateLeader[leader_name]" placeholder="Type Name Here" ><br>
<div id="leaderList" class="result_nominy_qty" ></div>
