...
<header>
			<div class="container">
				<div class="header-data">
					<div class="logo">
						<a href="<?= Yii::$app->urlManager->createUrl(['profile/index']);?>" title=""><img src="<?= Yii::$app->request->baseUrl.'/images/'.'rose-telegram-logo.png'; ?>" alt=""></a>
					</div><!--logo end-->
                    ...
                    <div class="user-account">
						...
						<div class="user-account-settingss">
                            ...
                            <ul class="us-links">
                                ...
                                <li><a href="<?= Yii::$app->urlManager->createUrl(['profile/listings?id='.Yii::$app->user->identity->id]);?>" title="">Follower Listings</a></li>
								<?php } ?>
					...
					<nav>
						<ul>
                            ...
                            <?php if(Yii::$app->user->identity->usertype == 'F') {  ?>
                                ...
                                <?php } else { ?>
                                <a href="<?= Yii::$app->urlManager->createUrl(['profile/index']);?>" title="">
                                <?php } ?>
							...
							<li>
								...
								<a href="<?= Yii::$app->urlManager->createUrl(['profile/invite-friends']);?>" title="">                             
									<span><img src="images/icon1.png" alt=""></span>
									Invite Friends
								</a>
							</li>
...
<footer>
			<div class="footy-sec mn no-margin">
				<div class="container">
					...
					<img class="fl-rgt img-responsive" src="images/logo2a.png" alt="">
				</div>
			</div>
		</footer><!--footer end-->
